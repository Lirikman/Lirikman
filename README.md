<div id="header" align=center>
  ...
  <h2>📌 Начинающий Golang-разработчик</h2>
</div>

<h3>🚀 Образование:</h3>
Hexlet - GO-разработчик

Хакасский технический институт, специализация - экономист

<h3>Дополнительное образование:</h3>
<ul type="square">
  <li>Hexlet - Разработка Golang для продвинутых</li>
  ...
  <li>Изучил разработку нейросетей в академии THE FOUNDER</li>
...
<h3>💻 Опыт работы:</h3>
  <p> Мои pet-проекты:</p>
<ul>
  <p>- Rest-сервис "Подписки пользователей"</p>
  <p>- CLI-утилита "Анализатор размера диска"</p>
  <p>- CLI-утилита "Генератор отличий"</p>
  <p>- Web-сервис "Сокращатель ссылок"</p>
  <p>- CLI-утилита "Парсер сайтов"</p>
...
<p>В настоящее время изучаю разработку на Golang, и ищу команду для работы и профессионального роста</p>
<p>Дополнительно - имею навыки разработки нейронных сетей, а также програмирование на Python</p>
